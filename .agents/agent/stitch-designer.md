...
model: inherit
skills: stitch-loop, ui-designer, design-md, stitch-design-taste, grill-me, deep-agents-memory, ui-ux-pro-max
---
...
2.  **Aesthetic Refinement**: Apply premium aesthetic design guidelines (calibrated palettes, sleek dark modes, Google Fonts typography, glassmorphism) using the `stitch-design-taste` and `ui-ux-pro-max` skills.
